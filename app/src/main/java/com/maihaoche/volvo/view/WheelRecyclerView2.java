...
public class WheelRecyclerView2 extends RecyclerView {

    //默认参数
    private final int DEFAULT_WIDTH = SizeUtil.dip2px(160);

    private final int DEFAULT_ITEM_HEIGHT = SizeUtil.dip2px(50);
    ...
    public WheelRecyclerView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private class WheelAdapter extends Adapter<WheelAdapter.WheelHolder> {
        ...
        public WheelHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            WheelHolder holder = new WheelHolder(LayoutInflater.from(getContext()).inflate(R.layout.item_wheel2, parent, false));
    ...
    private class DividerItemDecoration extends ItemDecoration {
        ...
        public void onDrawOver(Canvas c, RecyclerView parent, State state) {
            //绘制分割线
            float startX = 0;//getMeasuredWidth() / 2 - mDividerWidth / 2;
...
//            c.drawLine(startX, bottomY, endX, bottomY, mPaint);
            ...
            mPaint.setColor(Color.parseColor("#50e7e7e7"));
