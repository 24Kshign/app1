package com.maihaoche.volvo.ui.avchat.sound;
...
public class AVChatSoundPlayer {
    ...
    public AVChatSoundPlayer() {
        this.context = AVChatCache.getContext();
    ...
    public synchronized void play(RingerTypeEnum type) {
        LogUtil.i(TAG, "play type->" + type.name());
        ...
        if (ringId != 0) {
            play(ringId);
            vibrator.vibrate(new long[]{600, 800, 600, 800},1);
        }
    }
